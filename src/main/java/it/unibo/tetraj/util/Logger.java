 ...
 * library used.
 *
 * <p>Log levels follow the common standard: - TRACE: Very detailed information, typically only for
 * debugging - DEBUG: Detailed debug information - INFO: Informational messages that highlight the
 * progress of the application - WARN: Potentially harmful situations - ERROR: Error events that
 * might still allow the application to continue running - FATAL: Very severe error events that will
